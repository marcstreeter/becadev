...
export function Sidebar({
  navigation,
}: Omit<SidebarProps, "layout" | "onLayoutChange">) {
              ...
              return (
                <a
                  ...
                  className={cn(
                    ...
                    isActive &&
                      "bg-[var(--sidebar-active)] text-[hsl(var(--sidebar-fg))]"
                  )}
                >
            ...
            return (
              <a
                ...
                className={cn(
                  ...
                  isActive &&
                    "text-[hsl(var(--sidebar-fg))] bg-[var(--sidebar-active)]"
                )}
              >
    ...
    >
        ...
        {navigation?.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span className="sidebar-text relative z-10">{item.title}</span>
              {isActive && (
      ...
      <div className="py-4 border-t border-[var(--sidebar-hover)]">
        ...
        >
          ...
          <span className="sidebar-text">Switch Layout</span>
        </button>
        <div
          className={cn(
            "group flex items-center h-11 w-full hover:bg-[var(--sidebar-hover)] relative overflow-hidden",
